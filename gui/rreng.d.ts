...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h91a7d24a951a6b4e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h00e290d5b8144778: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h4b97111d5fed4dda: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h49beb6916a9fe44d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h016240a0332cfbcc: (a: number, b: number, c: number) => void;
