...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h204bcc715b17b797: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__he1b3c7a4b0b68c72: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h1543ccf94580ac9e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h2f8c54283bc0146c: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4a3f1af0c45ee58f: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h72752f64eb628425: (a: number, b: number, c: number) => void;
